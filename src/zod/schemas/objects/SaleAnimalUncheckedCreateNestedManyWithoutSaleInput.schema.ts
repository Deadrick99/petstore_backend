...
const Schema: z.ZodType<Prisma.SaleAnimalUncheckedCreateNestedManyWithoutSaleInput> =
  z.union([
    z
      .object({
        create: z
...
export const SaleAnimalUncheckedCreateNestedManyWithoutSaleInputObjectSchema =
  Schema;
