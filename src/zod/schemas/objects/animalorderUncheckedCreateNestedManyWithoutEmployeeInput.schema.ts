...
const Schema: z.ZodType<Prisma.animalorderUncheckedCreateNestedManyWithoutEmployeeInput> =
  z.union([
    z
      .object({
        create: z
...
export const animalorderUncheckedCreateNestedManyWithoutEmployeeInputObjectSchema =
  Schema;
