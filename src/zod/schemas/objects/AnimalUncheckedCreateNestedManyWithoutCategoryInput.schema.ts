...
const Schema: z.ZodType<Prisma.AnimalUncheckedCreateNestedManyWithoutCategoryInput> =
  z.union([
    z
      .object({
        create: z
...
export const AnimalUncheckedCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
