...
const Schema: z.ZodType<Prisma.orderitemUncheckedUpdateManyWithoutMerchandiseorderNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const orderitemUncheckedUpdateManyWithoutMerchandiseorderNestedInputObjectSchema =
  Schema;
