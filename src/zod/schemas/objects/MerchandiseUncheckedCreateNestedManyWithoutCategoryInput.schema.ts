...
const Schema: z.ZodType<Prisma.MerchandiseUncheckedCreateNestedManyWithoutCategoryInput> =
  z.union([
    z
      .object({
        create: z
...
export const MerchandiseUncheckedCreateNestedManyWithoutCategoryInputObjectSchema =
  Schema;
