...
const Schema: z.ZodType<Prisma.SupplierUncheckedUpdateWithoutMerchandiseOrderInput> =
  z
    .object({
      SUPPLIERID: z
        .union([
...
export const SupplierUncheckedUpdateWithoutMerchandiseOrderInputObjectSchema =
  Schema;
