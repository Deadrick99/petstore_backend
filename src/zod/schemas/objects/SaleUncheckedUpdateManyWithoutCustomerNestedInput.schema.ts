...
const Schema: z.ZodType<Prisma.SaleUncheckedUpdateManyWithoutCustomerNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const SaleUncheckedUpdateManyWithoutCustomerNestedInputObjectSchema =
  Schema;
