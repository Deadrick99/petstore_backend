...
const Schema: z.ZodType<Prisma.SaleAnimalUncheckedCreateNestedManyWithoutAnimalInput> =
  z.union([
    z
      .object({
        create: z
...
export const SaleAnimalUncheckedCreateNestedManyWithoutAnimalInputObjectSchema =
  Schema;
