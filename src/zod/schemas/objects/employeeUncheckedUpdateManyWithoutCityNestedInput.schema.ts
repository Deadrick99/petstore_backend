...
const Schema: z.ZodType<Prisma.employeeUncheckedUpdateManyWithoutCityNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const employeeUncheckedUpdateManyWithoutCityNestedInputObjectSchema =
  Schema;
