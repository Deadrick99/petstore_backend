...
const Schema: z.ZodType<Prisma.animalorderUpdateManyWithWhereWithoutSupplierInput> =
  z
    .object({
...
export const animalorderUpdateManyWithWhereWithoutSupplierInputObjectSchema =
  Schema;
