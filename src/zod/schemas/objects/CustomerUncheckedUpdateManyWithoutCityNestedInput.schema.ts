...
const Schema: z.ZodType<Prisma.CustomerUncheckedUpdateManyWithoutCityNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const CustomerUncheckedUpdateManyWithoutCityNestedInputObjectSchema =
  Schema;
