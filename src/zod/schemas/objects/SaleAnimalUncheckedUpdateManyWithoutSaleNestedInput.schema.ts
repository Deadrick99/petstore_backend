...
const Schema: z.ZodType<Prisma.SaleAnimalUncheckedUpdateManyWithoutSaleNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const SaleAnimalUncheckedUpdateManyWithoutSaleNestedInputObjectSchema =
  Schema;
