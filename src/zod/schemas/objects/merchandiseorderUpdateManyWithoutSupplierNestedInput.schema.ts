...
const Schema: z.ZodType<Prisma.merchandiseorderUpdateManyWithoutSupplierNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const merchandiseorderUpdateManyWithoutSupplierNestedInputObjectSchema =
  Schema;
