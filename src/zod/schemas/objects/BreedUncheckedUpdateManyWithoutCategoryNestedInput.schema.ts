...
const Schema: z.ZodType<Prisma.BreedUncheckedUpdateManyWithoutCategoryNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const BreedUncheckedUpdateManyWithoutCategoryNestedInputObjectSchema =
  Schema;
