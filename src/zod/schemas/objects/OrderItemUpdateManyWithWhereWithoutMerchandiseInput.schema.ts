...
const Schema: z.ZodType<Prisma.OrderItemUpdateManyWithWhereWithoutMerchandiseInput> =
  z
    .object({
...
export const OrderItemUpdateManyWithWhereWithoutMerchandiseInputObjectSchema =
  Schema;
