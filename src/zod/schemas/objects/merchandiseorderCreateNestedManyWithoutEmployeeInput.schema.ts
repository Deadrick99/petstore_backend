...
const Schema: z.ZodType<Prisma.merchandiseorderCreateNestedManyWithoutEmployeeInput> =
  z.union([
    z
      .object({
        create: z
...
export const merchandiseorderCreateNestedManyWithoutEmployeeInputObjectSchema =
  Schema;
