...
const Schema: z.ZodType<Prisma.AnimalOrderItemUpdateManyWithoutAnimalOrderNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const AnimalOrderItemUpdateManyWithoutAnimalOrderNestedInputObjectSchema =
  Schema;
