...
const Schema: z.ZodType<Prisma.saleanimalUpdateManyWithoutAnimalNestedInput> =
  z.union([
    z
      .object({
        create: z
...
export const saleanimalUpdateManyWithoutAnimalNestedInputObjectSchema = Schema;
